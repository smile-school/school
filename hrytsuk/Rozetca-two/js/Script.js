    ...
    function formValid(a) {
        ...
        function createElem(elem, attr,text) {
         ...
         function Valid(data) {
            ...
            var reting = createElem('div',{'class':'reting'}) ;
                reting.innerHtml +='<svg class="star-reid" viewBox="0 0 64 12" aria-label="Рейтинг товара">\n' +
                    '    <g>\n' +
                    '        <defs>\n' +
            ...
            var video = createElem('div',{'class':'video'},undefined) ;
            ...
            topComent.appendChild(video);
             ...
             var answerButon = createElem('button',{'class':'answer-bottom'},undefined) ;
            ...
            comentFooter.appendChild(answerButon);
             ...
             var butonLice = createElem('button',{'class':'answer-bottom buton-lice'},undefined);
