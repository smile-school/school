(function () {
    $.widget('smile.smilecarousel', {
        ...
        _getCurrentSlide: function (direction) {
            if (direction) {
                this.options.currentSlide = (this.options.currentSlide != this.options.countSlide - this.options.toShow) ? ((this.options.currentSlide + this.options.toSlide) < (this.options.countSlide - this.options.toShow)) ? this.options.currentSlide + this.options.toSlide : this.options.countSlide - this.options.toShow : this.options.countSlide - this.options.toShow;
            } else {
