(function () {
    $.widget('smile.smilecarousel',{
        ...
        _getCurrentSlide: function (direction) {
            if(direction){
                this.options.currentSlide = (this.options.currentSlide != this.options.countSlide - this.options.toShow) ?
                    ((this.options.currentSlide + this.options.toSlide) < (this.options.currentSlide - this.options.toShow)) ?
                ...
                this.options.currentSlide = (this.options.currentSlide != 0) ?
                    ((this.options.currentSlide - this.options.toShow) > 0) ?
        ...
        _go: function () {
            this.itemWrap.animate({'marginLeft':(this.options.currentSlide * this.options.itemWidth) + 'px'}, this.options.delay);
        },
        _setArrow: function () {
